...
// LomsClient is the client API for Loms checkout.
//
...
type LomsClient interface {
	...
	Stock(ctx context.Context, in *StocksRequest, opts ...grpc.CallOption) (*StocksResponse, error)
}
...
func (c *lomsClient) CancelOrder(ctx context.Context, in *CancelOrderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/checkout.Loms/CancelOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) CreateOrder(ctx context.Context, in *CreateOrderRequest, opts ...grpc.CallOption) (*CreateOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/checkout.Loms/CreateOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) ListOrder(ctx context.Context, in *ListOrderRequest, opts ...grpc.CallOption) (*ListOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/checkout.Loms/ListOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) OrderPayed(ctx context.Context, in *OrderPayedRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/checkout.Loms/OrderPayed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) Stock(ctx context.Context, in *StocksRequest, opts ...grpc.CallOption) (*StocksResponse, error) {
	out := new(StocksResponse)
	err := c.cc.Invoke(ctx, "/checkout.Loms/Stock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// LomsServer is the server API for Loms checkout.
...
type LomsServer interface {
	...
	Stock(context.Context, *StocksRequest) (*StocksResponse, error)
...
func (UnimplementedLomsServer) Stock(context.Context, *StocksRequest) (*StocksResponse, error) {
...
// UnsafeLomsServer may be embedded to opt out of forward compatibility for this checkout.
...
func _Loms_CancelOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/checkout.Loms/CancelOrder",
	}
...
func _Loms_CreateOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/checkout.Loms/CreateOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Loms_ListOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/checkout.Loms/ListOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Loms_OrderPayed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/checkout.Loms/OrderPayed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Loms_Stock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StocksRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LomsServer).Stock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/checkout.Loms/Stock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LomsServer).Stock(ctx, req.(*StocksRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// Loms_ServiceDesc is the grpc.ServiceDesc for Loms checkout.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var Loms_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "checkout.Loms",
